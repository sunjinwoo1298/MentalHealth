...
import { JournalEntry, JournalFormData, MoodOption } from '../types/journal';
...
const JournalPage: React.FC = () => {
  ...
  const moodOptions = {
    'very-sad': { emoji: '😢', label: 'Very Sad', color: 'from-blue-400 to-blue-600' },
    'sad': { emoji: '😔', label: 'Sad', color: 'from-indigo-400 to-indigo-600' },
    'neutral': { emoji: '😐', label: 'Neutral', color: 'from-gray-400 to-gray-600' },
    'happy': { emoji: '🙂', label: 'Happy', color: 'from-green-400 to-green-600' },
    'very-happy': { emoji: '😊', label: 'Very Happy', color: 'from-yellow-400 to-yellow-600' },
    'excited': { emoji: '🤩', label: 'Excited', color: 'from-orange-400 to-orange-600' },
    'grateful': { emoji: '🙏', label: 'Grateful', color: 'from-pink-400 to-pink-600' },
    'peaceful': { emoji: '😌', label: 'Peaceful', color: 'from-purple-400 to-purple-600' }
  };

  const predefinedTags = [
    { name: 'Gratitude', color: 'bg-pink-100 text-pink-800 border-pink-200' },
    { name: 'Growth', color: 'bg-green-100 text-green-800 border-green-200' },
    { name: 'Mindfulness', color: 'bg-purple-100 text-purple-800 border-purple-200' },
    { name: 'Relationships', color: 'bg-red-100 text-red-800 border-red-200' },
    { name: 'Work', color: 'bg-blue-100 text-blue-800 border-blue-200' },
    { name: 'Health', color: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
    { name: 'Creativity', color: 'bg-orange-100 text-orange-800 border-orange-200' },
    { name: 'Dreams', color: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
    { name: 'Self-care', color: 'bg-teal-100 text-teal-800 border-teal-200' },
    { name: 'Goals', color: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
    { name: 'Family', color: 'bg-rose-100 text-rose-800 border-rose-200' },
    { name: 'Meditation', color: 'bg-violet-100 text-violet-800 border-violet-200' }
  ];
